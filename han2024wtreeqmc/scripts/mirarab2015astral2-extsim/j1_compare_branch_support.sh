...
for QSUP in "qsupp-wh" "qsupp-wn"; do
    STRE_TRUE="$DATADIR/true_stree_${SUPP}_${NGEN}gen_${QSUP}.tre"
    STRE_EST1="$DATADIR/${MTHD1}_${SUPP}_${NGEN}gen_${QSUP}.tre"
    STRE_EST2="$DATADIR/${MTHD2}_${SUPP}_${NGEN}gen_${QSUP}.tre"
    OUTF="$DATADIR/branch_support_${MTHD1}_vs_${MTHD2}_for_${SUPP}_${NGEN}gen_${QSUP}.csv"
