...
def make_figure(df, output):
    ...
    modls = [50, 100, 200, 500] # varying number of base pairs
    ...
    for doit in [0, 1]:
        ...
        if doit == 0:
            ...
            ax.set_xlabel(r"Sequence Length", fontsize=12)
...
# Read and plot data
df = pandas.read_csv("../../csvs/data-varynbps-error-and-timings.csv")
make_figure(df, "plot-asteroid-varynbps.pdf")
