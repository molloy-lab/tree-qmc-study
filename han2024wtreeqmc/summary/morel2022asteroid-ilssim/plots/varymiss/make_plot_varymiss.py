...
def make_figure(df, output):
    ...
    modls = [0.5, 0.55, 0.6, 0.65, 0.7, 0.75] # varying missingness parameter
    ...
    for doit in [0, 1]:
        ...
        if doit == 0:
            ...
            ax.set_xlabel(r"Missingness Parameter", fontsize=12)
...
# Read and plot data
df = pandas.read_csv("../../csvs/data-varymiss-error-and-timings.csv")
make_figure(df, "plot-asteroid-varymiss.pdf")
