...
def make_figure(df, output):
    ...
    modls = [25, 50, 75, 100, 125, 150] # varying number of taxa
    ...
    for doit in [0, 1]:
        ...
        if doit == 0:
            ...
            ax.set_xlabel(r"Number of Taxa", fontsize=12)
...
# Read and plot data
df = pandas.read_csv("../../csvs/data-varyntax-error-and-timings.csv")
make_figure(df, "plot-asteroid-varyntax.pdf")
