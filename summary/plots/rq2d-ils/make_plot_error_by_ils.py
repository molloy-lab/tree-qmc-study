...
def make_figure(dfs, output):
    ...
    ax10 = plt.subplot(gs[0,1])  ## avian

    [df1, df2] = dfs

    # Plot error for avian with varying ILS
    ax = ax00
    varys = ["0.5X", "1X", "2X"]
    vnams = ["0.5X", "1X", "2X"]
    n = len(varys)
    ...
    # Set labels
    ax.set_title(letters[0] + " Avian (48 taxa, 1000 estimated gene trees - 500 bp)",
                 loc="left", x=0.0, y=1.0, fontsize=10.5)
    ax.set_ylabel(r"Percent RF Error", fontsize=11)  

    ax.tick_params(axis='x', labelsize=9.5)
    ax.tick_params(axis='y', labelsize=8.5)
    ax.set_xlabel("Species Tree Height (Decreasing ILS)", 
                  fontsize=11)
    ...
    # Plot error for mammalian with varying ILS
    ax = ax10
    varys = ["scale2d", "noscale",  "scale2u"]
    vnams = ["0.5X", "1X", "2X"]
    ...
    # Set labels
    ax.set_title(letters[1] + " Mammalian (37 taxa, 200 estimated gene trees - 500 bp)",
                 loc="left", x=0.0, y=1.0, fontsize=10.5)
    #ax.set_ylabel(r"Percent RF Error", fontsize=11)  
    ...
    fig.suptitle("Impact of ILS", fontsize=12, x = 0.5, y = 0.98)
    gs.tight_layout(fig, rect=[0, 0.1, 1, 0.94])
    hs = []
    for k in range(len(mnams)):
        ...
        ax.legend(hs, mnams,
                  ...
                  fontsize=10,
                  loc='lower center', 
                  bbox_to_anchor=(-0.06, -0.6, 0, 3))
        # bbox_to_anchor=(-0.08, -0.6, 0, 3)
