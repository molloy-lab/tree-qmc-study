...
def make_figure(dfs, output):
    ...
    ax00 = plt.subplot(gs[0,0])  ## mammalian
    ax10 = plt.subplot(gs[1,0])  ## avian

    [df1, df2] = dfs

    # Plot error for varying number of genes
    ax = ax00
    ...
    #ax.set_title(letters[0] + " Avian 1X (48 taxa, true gene trees)",
    ...
    # Set labels
    #ax.set_title(letters[1] + " Mammalian 1X (37 taxa, estimated gene trees - 500 bp)",
    #             loc="left", x=0.0, y=1.0, fontsize=10.5)
    ax.set_title(upperletters[1] + " Mammalian 1X (37 taxa, estimated gene trees - 500 bp)",
                 loc="left", fontsize=11)
    ax.set_ylabel(r"Percent RF Error", fontsize=11)  
...
# Read and plot data
df1 = pandas.read_csv("../../mahbub2021wqfm-avian/csvs/data-all-error-and-timings.csv")
df2 = pandas.read_csv("../../mahbub2021wqfm-mammalian/csvs/data-all-error-and-timings.csv")

title = "supplot-rq4b-ngen.pdf"
make_figure([df1, df2], title)
