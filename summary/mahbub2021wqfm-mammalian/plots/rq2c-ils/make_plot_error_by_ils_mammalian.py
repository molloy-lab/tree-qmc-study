...
def make_figure(df, output):
    ...
    ax = plt.subplot(gs[0,0])  ## mammalian
    ...
    # Set labels
    #ax.set_title("Impact of ILS on Mammalian (37 taxa, 200 estimated gene trees - 500 bp)", 
    #             loc="center", y=1.15, fontsize=11)
    ax.set_title(upperletters[0] + str(" Species tree scale 1X"),
    ...
    ax.set_xlabel("Species Tree Scale (Decreasing ILS)", 
                  fontsize=12)
...
title = "supplot-rq2c-ils-mammalian.pdf"
