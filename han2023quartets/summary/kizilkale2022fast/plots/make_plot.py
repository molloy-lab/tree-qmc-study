...
def make_figure(df, output):
    ...
    ax00 = plt.subplot(gs[0,0])  ## FN  300 x 300
    ax01 = plt.subplot(gs[0,1])  ## FN  300 x 1000
    ax02 = plt.subplot(gs[0,2])  ## FN 1000 x 300

    ax10 = plt.subplot(gs[1,0])  ## FP  300 x 300
    ax11 = plt.subplot(gs[1,1])  ## FP  300 x 1000
    ax12 = plt.subplot(gs[1,2])  ## FP 1000 x 300

    ax20 = plt.subplot(gs[2,0])  ## RT  300 x 300
    ax21 = plt.subplot(gs[2,1])  ## RT  300 x 1000
    ax22 = plt.subplot(gs[2,2])  ## RT 1000 x 300
